...
describe("Strategy Tests", () => {
   ...
   it("toConfig", () => {
      let s = new Strategy <any,any>({ num:"45", numType:"num", boo:true, booType:"bool" , tf: "45", tfType:"num", fld: "Just a field"},{numberFields:["num"], booleanFields:["boo"], typeFields:["tf"]},RED)
